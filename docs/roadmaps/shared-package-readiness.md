...
| Package validation | [Operations](../operations.md) | Formal fail-closed ten-file runner, targeted CCB/role checks, maintained error assertions, and release guard | Node 22/24 workflow suite and Node 24 guard evidence exists for published 3.0.0-dev.1; supported range and complete compatibility baseline remain open |
