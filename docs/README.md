...
| [3.0.0-dev.3 release evidence](evidence/release-3.0.0-dev.3.md) | SiteOperationSchedule next-day notification correction commit/tag, workflow, registry content, and fresh-install verification |
