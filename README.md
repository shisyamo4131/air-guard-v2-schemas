...
Version `3.0.0-dev.2` corrects `ArrangementNotification` confirmation-timestamp preservation and actual start/end date calculations. Actual dates use the actual next-day flag and JST date composition, including overnight and 24-hour cases, without depending on the process time zone.
